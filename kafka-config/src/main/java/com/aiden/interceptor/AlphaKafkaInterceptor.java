 ...
 * @author Aiden
 * @version 1.0
 * @description 自定义kafka拦截器 实现发送消息前对消息做一些预处理
 * @date 2021-4-24 10:02:28
 */

@Component
public class AlphaKafkaInterceptor implements ProducerInterceptor<String, String> {
    /**
    ...
    public ProducerRecord<String, String> onSend(ProducerRecord<String, String> record) {
        // 发送消息到kafka服务器之前执行的方法, 可以在这里对消息做一些预处理
        return record;
    }
    ...
    public void onAcknowledgement(RecordMetadata metadata, Exception exception) {
        // 消息发送到kafka服务器之后执行的方法, 无论这个消息是否发送成功都会执行
    }
